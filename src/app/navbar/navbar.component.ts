      ...
      <div class="container-fluid d-flex justify-content-between" #myDiv>
        ...
        <div class="collapse navbar-collapse" [ngbCollapse]="isMenuCollapsed" id="navbarTogglerDemo02">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <!--Github-->
            <li class="nav-item">
             <a class="nav-link" (click)="isMenuCollapsed = true" aria-label="link to Github account" title="link to Github account" href="https://github.com/thusbandUK" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
